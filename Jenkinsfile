...
DLQ_CONSUMER_GROUP_AUTH=${DLQ_CONSUMER_GROUP_AUTH}
DLQ_CONSUMER_GROUP_ORDER=${DLQ_CONSUMER_GROUP_ORDER}
DLQ_CONSUMER_GROUP_USER=${DLQ_CONSUMER_GROUP_USER}
DLQ_CONSUMER_GROUP_PAYMENT=${DLQ_CONSUMER_GROUP_PAYMENT}
DLQ_CONSUMER_GROUP_INVENTORY=${DLQ_CONSUMER_GROUP_INVENTORY}
DLQ_CONSUMER_GROUP_RESERVATION=${DLQ_CONSUMER_GROUP_RESERVATION}
EOF
